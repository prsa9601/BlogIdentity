...
namespace Blog.Application.User.SendEmail
{
    public class SendEmailCommand : IBaseCommand<string>
    {
    ...
    public class SendEmailCommandHandler : IBaseCommandHandler<SendEmailCommand, string>
    {
        ...
        public SendEmailCommandHandler(UserManager<Domain.UserAgg.User> userManager, IUserRepository<Domain.UserAgg.User> repository)
        {
            _userManager = userManager;
            _repository = repository;
        }

        public async Task<OperationResult<string>> Handle(SendEmailCommand request, CancellationToken cancellationToken)
        {
